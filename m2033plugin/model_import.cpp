...
void ModelImport::read_model( Reader* reader, MeshList& meshes )
{
	int id, size, off;
	char buffer[1024];
	StringList names;
...
void ModelImport::read_static_model( Reader* reader, MeshList& meshes )
{
}

void ModelImport::read_dynamic_model( Reader* reader, MeshList& meshes )
{
}