...
private:
	void read_model( Reader* reader, MeshList& meshes );
	void read_static_model( Reader* reader, MeshList& meshes );
	void read_dynamic_model( Reader* reader, MeshList& meshes );
